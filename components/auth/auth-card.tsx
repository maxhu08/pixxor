...
import { loginAction, registerAction, signInWithOAuthAction } from "@/lib/actions/account-actions";
  ...
  return (
    <div className="flex w-full flex-col gap-3">
      ...
      <Button
        ...
        className="flex w-full cursor-pointer items-center justify-start gap-2 bg-black px-4 text-white transition-colors duration-300 hover:bg-neutral-800"
      >
        ...
        <Tabs value={activeTab} onValueChange={handleTabChange}>
          ...
          <Card className="gap-4 p-6">
            ...
            <div className="flex items-center gap-4">
              ...
              <span className="text-muted-foreground text-sm whitespace-nowrap">or</span>
              <Separator className="flex-1" />
            </div>
            <SocialLogins />
          </Card>
